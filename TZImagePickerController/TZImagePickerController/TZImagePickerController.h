...
#pragma mark - edit
@property (nonatomic, copy) void (^didFinishEditPickingPhotosHandle)(NSArray<UIImage *> *photos,NSArray *assets,BOOL isSelectOriginalPhoto, TZImagePickerController *picker);
